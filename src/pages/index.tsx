...
export const getServerSideProps: GetServerSideProps<MainboardProps> = async (context) => {
  try {
    ...
    const response = await TimeLineModel.find({ authorId: session.user.email }).sort({ createdAt: -1 }).limit(10).lean();
